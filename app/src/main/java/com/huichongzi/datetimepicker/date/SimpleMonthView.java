...
import static com.huichongzi.datetimepicker.date.SimpleMonthAdapter.CalendarDay;
...
// Selection is (x - start) / (pixels/day) == (x -s) * day / pixels
     ...
     * {@link com.huichongzi.datetimepicker.date.SimpleMonthView.OnDayClickListener} if one is set.
     *
